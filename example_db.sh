...
curl -X POST http://127.0.0.1:5984/husharu_db -H 'Content-type: application/json' -d "{\"level\": \"comment\", \"parent_id\": \"\", \"product_id\": \"$iddd\", \"posted_by\": \"Shady Joe\", \"created_by\": \"1322550106\", \"comment\": \"This project is yet to start.\" }"
